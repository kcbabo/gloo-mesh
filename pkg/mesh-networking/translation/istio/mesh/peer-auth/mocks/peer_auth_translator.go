...
func (m *MockTranslator) Translate(mesh *v1.Mesh, istioOutputs istio.Builder, reporter reporting.Reporter) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Translate", mesh, istioOutputs, reporter)
}

// Translate indicates an expected call of Translate.
func (mr *MockTranslatorMockRecorder) Translate(mesh, istioOutputs, reporter interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Translate", reflect.TypeOf((*MockTranslator)(nil).Translate), mesh, istioOutputs, reporter)
}
