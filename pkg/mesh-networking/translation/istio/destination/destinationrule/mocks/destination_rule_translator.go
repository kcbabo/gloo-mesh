...
func (m *MockTranslator) Translate(ctx context.Context, in input.LocalSnapshot, destination *v1.Destination, sourceMeshInstallation *v1.MeshInstallation, reporter reporting.Reporter) *v1alpha3.DestinationRule {
	m.ctrl.T.Helper()
