...
## Table of Contents
  - [DeprecatedHttpMatcher](#common.mesh.gloo.solo.io.DeprecatedHttpMatcher)
  - [DeprecatedHttpMatcher.QueryParameterMatcher](#common.mesh.gloo.solo.io.DeprecatedHttpMatcher.QueryParameterMatcher)
...
<a name="common.mesh.gloo.solo.io.DeprecatedHttpMatcher"></a>
...
| name | string |  | The name assigned to a match. The match's name will be concatenated with the parent route's name and will be logged in the access logs for requests matching this route. |
  ...
  | queryParameters | [][common.mesh.gloo.solo.io.DeprecatedHttpMatcher.QueryParameterMatcher]({{< versioned_link_path fromRoot="/reference/api/github.com.solo-io.gloo-mesh.api.common.v1.request_matchers#common.mesh.gloo.solo.io.DeprecatedHttpMatcher.QueryParameterMatcher" >}}) | repeated | Specify a set of URL query parameters which requests must match in entirety (all query params must match). |
...
<a name="common.mesh.gloo.solo.io.DeprecatedHttpMatcher.QueryParameterMatcher"></a>
