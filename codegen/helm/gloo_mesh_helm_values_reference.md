...
|settings|struct|{"mtls":{"istio":{"tlsMode":"ISTIO_MUTUAL"}},"networkingExtensionServers":[],"discovery":{"istio":{"ingressGatewayDetectors":{}}},"relay":{"enabled":false,"server":{"address":"","insecure":false,"reconnectOnNetworkFailures":false}},"peerAuth":{"enabled":true,"peerAuthTlsMode":"UNSET"}}|Values for the Settings object. See the [Settings API doc](../../../../api/github.com.solo-io.gloo-mesh.api.settings.v1.settings) for details.|
...
|settings.peer_auth|struct|{"enabled":true}||
|settings.peer_auth.enabled|bool|true||
|settings.peer_auth.peer_auth_tls_mode|int32|0||
